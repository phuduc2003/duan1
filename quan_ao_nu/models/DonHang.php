...
class DonHang
{
    ...
    public function addDonHang($tai_khoan_id, $ten_nguoi_nhan, $email_nguoi_nhan, $dia_chi_nguoi_nhan, $sdt_nguoi_nhan, $ghi_chu, $tong_tien, $phuong_thuc_thanh_toan_id, $ngay_dat, $ma_don_hang, $trang_thai_id)
    {

        try {
            $sql = 'INSERT into don_hangs (tai_khoan_id,ten_nguoi_nhan,email_nguoi_nhan,dia_chi_nguoi_nhan,sdt_nguoi_nhan,ghi_chu,tong_tien,phuong_thuc_thanh_toan_id,ngay_dat,ma_don_hang, trang_thai_id) value 
            (:tai_khoan_id,:ten_nguoi_nhan,:email_nguoi_nhan,:dia_chi_nguoi_nhan,:sdt_nguoi_nhan,:ghi_chu,:tong_tien,:phuong_thuc_thanh_toan_id,:ngay_dat,:ma_don_hang, :trang_thai_id)';
