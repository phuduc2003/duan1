...
<div class="row">
    ...
    <div class="">
        ...
        <input type="text" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập tên sản phẩm" name="ten_san_pham" value="<?=$san_phams->ten_san_pham  ?>">
    </div>
    <div class="">
        <label for="inputPassword4" class="form-label">Mô tả</label>
        <textarea name="mo_ta" id="description" cols="30" rows="3" class="form-control" placeholder="Mô tả" value="<?= $san_phams->mo_ta  ?>"></textarea>
    </div>
    <div class="">
        <label for="inputEmail4" class="form-label">Số lượng</label>
        <input type="number" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập số lượng" name="so_luong" value="<?= $san_phams->so_luong  ?>">
    </div>
    <div class="">
        <label for="inputEmail4" class="form-label">Giá</label>
        <input type="number" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá bán" name="gia_san_pham" value="<?= $san_phams->gia_san_pham  ?>">
    </div>
    <div class="">
        <label for="inputEmail4" class="form-label">Lượt Xem</label>
        <input type="number" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá bán" name="luot_xem" value="<?= $san_phams->luot_xem  ?>">
    </div>
    <div class="">
        <label for="inputEmail4" class="form-label">SALE</label>
        <input type="number" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá sale" name="gia_khuyen_mai" value="<?= $san_phams->gia_khuyen_mai  ?>">
    </div>
    <div class="">
        <label for="inputEmail4" class="form-label">Ngày Sản Xuất</label>
        <input type="date" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá bán" name="ngay_nhap" value="<?= $san_phams->ngay_nhap  ?>">
    </div>
    <div class="mt-3">
