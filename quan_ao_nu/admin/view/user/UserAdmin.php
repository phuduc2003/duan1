...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="?act=admin-createUser" class="btn add-product-btn">+ Add New Account</a>
    </div>
    ...
    <div class="table-wrapper">
        <table class="table table-striped table-hover text-center">
            ...
            <?php foreach ($DanhSachUser as $admins) {
                if($admins->chuc_vu_id == 1 && $admins->trang_thai == 1 ){
                ?>     
                <tr>
                    ...
                    <td> <?php if( $admins->gioi_tinh ==1) {echo"Nam";}else{echo"Nữ";}?></td> <td>
                        ...
                        <img style="max-height:100%; max-width:100%;" src="<?= $admins->anh_dai_dien ?>">
                        </div>
                    </td>
                    ...
                    <button class="btn btn-success">
                                ...
                                <button class="btn btn-danger" name="delete">
                                    <a href="?act=admin-lockuser&id=<?= $admins->id ?> " style="text-decoration:none;" class="text-white" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">
                                        <i class="fa-solid fa-trash" ></i> Lock
                                    </a>
                                </button> 
...
<div class="container mt-5">
    ...
    <div class="table-wrapper">
        <table class="table table-striped table-hover text-center">
            ...
            <tbody>
            <?php foreach ($DanhSachUser as $admins) {
                if($admins->chuc_vu_id == 2 && $admins->trang_thai == 1){
                ?>     
                <tr>
