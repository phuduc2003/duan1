            ...
            <?php foreach ($danhSachDanhMuc as $admins) {
                ...
                <tr>
                    ...
                    <button class="btn btn-success">
                                    <a href="?act=admin-updatedm&id=<?= $admins->id ?>" class="text-white" style="text-decoration:none;">
                                        <i class="fa-solid fa-pen-to-square"></i> Fix
                                    </a>
                                </button>
                                
                                <button class="btn btn-danger" name="delete">
                                    <a href="?act=admin-deletedm&id=<?= $admins->id ?> " style="text-decoration:none;" class="text-white" onclick="return confirm('Are you sure you want to delete?')">
